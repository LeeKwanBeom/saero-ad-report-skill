...
| 등록일 | 위치 | 목록(원본) | 비고 |
|---|---|---|---|
| 2026-09-25 제안(미등록) | 파워링크 그룹 "확장 검색" 칸 제안 | 노원구체험관 · 노원역생선구이새로오픈 · 노원역아기옷 · 노원역의류 · 노원역카페새로생긴 · 한스노원역 · 노원아기랑체험 | 7개 제안(09-25 채팅). 9/24 첫 등장 무관 6 + 키즈 계열 1(노원아기랑체험, 누적 6). 애매 4개(노원스텝핑·노원역어깨·노원역쾌적한·노원역금호스)는 사용자 판단 대기 — 목록에 넣지 않음. **등록 확인되면 등록일을 채우고 다음 날부터 대조** |
...
- 다음 회차 대조: 32개 재노출("확장" 행만, 등록 위치 답 받은 뒤 판정) / 17·22개 0 유지 / 9개(9/25~) / 제안 7개 등록 여부 / 추석 연휴(9/25·9/26) 노출·클릭("가능성"으로만) / 파워링크 연속 클릭·노원산전 클릭 재개 / 누적 CTR 3.1%대 / 매체 top5 순위 재대조 / 의정부·영등포 TOP 10 / 상계동 30회 둘째 날 / 힐링정원·엠코·아트 재등장.
...
| 노원필라테스힐링정원내돈내산(9/24 확장 1) | 보류(표 미등재) — 채팅 확인 요청 | 정원 변형인지 다른 업체("힐링정원")인지 불분명. 웹 검색(노원 힐링정원 필라테스) 특정 불가. 12번 각주에 언급 | 09-25 |
