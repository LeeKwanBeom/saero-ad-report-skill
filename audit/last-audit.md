...
- 다음 회차 대조: 17개·22개·**32개(9/24~)** 재노출("확장" 행만) / 새 목록 9개 등록일 받으면 다음 날부터 판정 / (파트너 매체는 사용자 보고 전까지 추적 안 함) / 9/24~9/26 추석 연휴 기간 노출·클릭(연휴 영향 서술은 "가능성"으로만) / 파트너 매체 하루 10회 이상·문의 답변 / 상계동 30회 둘째 날·클릭 지속 / 노원산전 30회대 복귀 여부 / 누적 CTR 3% 유지 / 의정부·영등포 TOP 10 재교체 / 필라테스정원·라임·1회짜리 보류 후보 재등장.
