...
| 노원오프닝필라테스(누적 4회 — 9/14 3회) | 보류(표 미등재) — **사용자 확인 대기** | 브랜드명("오프닝필라테스")인지 "새로 오픈" 계열 일반 검색인지 갈리지 않음. 클릭 0. 07번 각주·11번 (참고)에만 언급 | 09-15 |
| 필라테스인 계열(필라테스인노원 12 · 노원필라테스인 4 = 16회) | 보류(표 미등재) — **사용자 확인 대기** | 2회차 이상 클릭 0 노출 목록에 있던 이름인데 브랜드명 가능성이 있어 이번에 처음 후보로 올림. 확정 전까지 클릭 0 목록에 그대로 둠 | 09-15 |
